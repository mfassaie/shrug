...
fn test_completions_bash() {
    ...
    let result = runner.run(&["completions", "bash"]);
    result.assert_success();
    assert!(
...
fn test_completions_zsh() {
    ...
    let result = runner.run(&["completions", "zsh"]);
    result.assert_success();
    assert!(
        !result.stdout.trim().is_empty(),
...
fn test_completions_fish() {
    ...
    let result = runner.run(&["completions", "fish"]);
    result.assert_success();
    assert!(
        !result.stdout.trim().is_empty(),
...
fn test_completions_powershell() {
    ...
    let result = runner.run(&["completions", "powershell"]);
    result.assert_success();
    assert!(
        !result.stdout.trim().is_empty(),
